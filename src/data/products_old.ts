...
// Real products matching Shopify inventory
export const sampleProducts: Product[] = [
  // Necklaces from actual Shopify store
  {
    ...
    price: { amount: 109, currency: 'USD', display: '$109.00' },
  ...
  },
  {
    ...
    price: { amount: 199, currency: 'USD', display: '$199.00' },
